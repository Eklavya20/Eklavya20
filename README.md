...
An open-source Python library for end-to-end model diagnostics.

| Pillar | What it covers |
|---|---|
| Performance | Classification & regression metrics |
| Calibration | Reliability curves, ECE, Brier score |
| Drift Detection | Feature & prediction drift over time |
| Dataset Diagnostics | Class imbalance, missing data, outliers |
